    ...
    <div>
      <NavContainer>
        ...
        {/* <div id='mobile'> */}
          ...
          {/* <FontAwesomeIcon style={{color:"red"}} icon={faBars} />
           */}
          {/* <div><FontAwesomeIcon className='side_nav' onClick={()=>{setMenuState(!menuState); setSideMenuState(!sideMenuState);}} style={{color:"#fff"}} icon={menuState == true ? faBars : faTimes}></FontAwesomeIcon></div> */}
